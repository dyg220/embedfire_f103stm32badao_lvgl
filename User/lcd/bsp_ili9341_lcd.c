...
void ILI9341_Fill_Color ( uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t *usColor )
{
	uint32_t i, Amout_Point;
	
	Amout_Point = (x2-x1+1) * (y2-y1+1);
	
	ILI9341_OpenWindow ( x1, y1, x2-x1+1, y2-y1+1 );

	ILI9341_Write_Cmd ( CMD_SetPixel );	
		
	for ( i = 0; i < Amout_Point; i ++ )
		ILI9341_Write_Data ( usColor[i] );
}
